  ...
  MINOVATE.global = {
    ...
    layout: function() {
      var defaultHeaderScheme = 'scheme-light',
          defaultNavbarScheme = 'scheme-light',
          defaultBrandingScheme = 'scheme-light',
          ...
          defaultAppClasses = 'scheme-default default-scheme-color header-fixed aside-fixed rightbar-hidden hz-menu';
