...
var app = angular.module('starter', ['ionic', 'ionic-material', 'angular-svg-round-progressbar', 'pr.longpress', 'ngStorage']);
...
app.run(function ($rootScope, $http, $location, $localStorage) {
	...
	$rootScope.$on('$locationChangeStart', function (event, next, current) {
		var publicPages = ['/login', '/intro', 'subscribe', 'subscription_type', 'payment'];
