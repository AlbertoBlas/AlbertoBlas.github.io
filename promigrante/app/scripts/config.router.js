      ...
      function ( $stateProvider,   $urlRouterProvider,  MODULE_CONFIG ) {
        ...
        $stateProvider
          .state('app', {
            ...
            .state('app.dashboard', {
              url: '/dashboard',
              templateUrl: 'views/profamilia/dashboard.html',
              data : { title: 'Dashboard', folded: true },
              resolve: load(['scripts/controllers/chart.js','scripts/controllers/vectormap.js'])
            })
            .state('app.events_open', {
              url: '/events/open',
              templateUrl: 'views/profamilia/events_open.html',
              data : { title: 'Eventos activos', folded: true },
              resolve: load('scripts/controllers/bootstrap.js')
            })
            .state('app.events_closed', {
              url: '/events/closed',
              templateUrl: 'views/profamilia/events_closed.html',
              data : { title: 'Eventos cerrados', folded: true }
            })
            .state('app.feed_new', {
              url: '/feed_new',
              templateUrl: 'views/profamilia/feed_new.html',
              data : { title: 'New feed', folded: true },
                controller: 'EditorCtrl',
                resolve: load(['textAngular','scripts/controllers/editor.js'])
            })
            .state('app.news_feeds', {
              url: '/news_feeds',
              templateUrl: 'views/profamilia/news_feeds.html',
              data : { title: 'New feed', folded: true }
            })
            .state('app.subscriptions', {
              url: '/subscriptions',
              templateUrl: 'views/profamilia/subscriptions.html',
              data : { title: 'Suscripciones', folded: true }
            })
            .state('app.notifications', {
              url: '/notifications',
              templateUrl: 'views/profamilia/notifications.html',
              data : { title: 'Notificaciones', folded: true }
            })
            .state('app.catalogs', {
              url: '/catalogs',
              templateUrl: 'views/profamilia/catalogs.html',
              data : { title: 'Admin MARPEX', folded: true }
            })
            .state('app.help', {
              url: '/help',
              templateUrl: 'views/profamilia/help.html',
              data : { title: 'help', folded: true }
            })
						.state('access.lockme', {
              url: '/lockme',
              templateUrl: 'views/profamilia/lock_screen.html'
            })
						.state('access.signin', {
              url: '/signin',
